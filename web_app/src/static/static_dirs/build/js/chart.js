...
function dpu_date_wise_charts(data){
    if ("undefined" != typeof echarts) {
        ...
        if ($("#rolldown_dpu_date_wise").length) {
            var f = echarts.init(document.getElementById("rolldown_dpu_date_wise"), a);
            f.setOption({
                title: {
        ...
        if ($("#final_dpu_date_wise").length) {
            var f = echarts.init(document.getElementById("final_dpu_date_wise"), a);
            f.setOption({
                title: {
                    text: "Defects Per Unit",
                },
        ...
        if ($("#overall_dpu_date_wise").length) {
            var f = echarts.init(document.getElementById("overall_dpu_date_wise"), a);
            f.setOption({
                title: {
                    text: "Defects Per Unit",
                },
