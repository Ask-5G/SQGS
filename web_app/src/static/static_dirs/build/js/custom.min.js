...
function init_parsley() {
    if ("undefined" != typeof parsley) {
        ...
        $("parsley:field:validate", function() {
            ...
            $("#filter").parsley().validate(), a()
        });
        var a = function() {
            !0 === $("#filter").parsley().isValid() ? ($(".bs-callout-info").removeClass("hidden"), $(".bs-callout-warning").addClass("hidden")) : ($(".bs-callout-info").addClass("hidden"), $(".bs-callout-warning").removeClass("hidden"))
        };
        try {
...
function init_charts() {
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#agcoChart").length) {
            var f = document.getElementById("agcoChart");
            new Chart(f, {
                type: "bar",
                data: {
                    labels: ["DOT 1", "DOT 2", "DOT 3", "DOT 4", "DOT 5", "Final Inspection"],
                    datasets: [{
                        label: "# of Tractors",
                        backgroundColor: "#26B99A",
                        data: [40, 33, 38, 31, 11, 38]
                    }]
                },
                options: {
                    scales: {
        ...
        if ($("#hhpChart").length) {
            var f = document.getElementById("hhpChart");
            new Chart(f, {
                type: "bar",
                data: {
                    labels: ["635", "574", "GX293", "GX294", "GX295"],
                    datasets: [{
                        label: "# of Tractors",
                        backgroundColor: "#26B99A",
                        data: [18, 12, 4, 3, 4]
        ...
        if ($("#lhpChart").length) {
            var f = document.getElementById("lhpChart");
            new Chart(f, {
                type: "bar",
                data: {
                    labels: ["Scratches", "Damage", "Mismatch", "Missing"],
                    datasets: [{
                        label: "# of Tractors",
                        backgroundColor: "#26B99A",
                        data: [22, 17, 25, 28]
